...
<div align="center">
  ...
  *A high-performance, minimalist personal link portal powered by React, Vite, and GSAP.*
  ...
  [![Live Demo](https://img.shields.io/badge/Live-Demo-blue?style=flat-square&logo=vercel)](https://fatah.web.id/)
...
**🌐 Live Website:** [https://fatah.web.id](https://fatah.web.id)
